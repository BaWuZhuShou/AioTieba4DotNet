...
public sealed class ForumImageMapperTests
{
    ...
    public void ToImage_AcceptsTrimmedJpgAlias_AndReturnsEmptyForMalformedJpegShapes()
    {
        ...
        var invalidSegmentLength =
            ForumImageMapper.ToImage([0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00], "image/jpeg");
        ...
        var shortFrame =
            ForumImageMapper.ToImage([0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x07, 0x08, 0x00, 0x10, 0x00], "image/jpeg");
        var shortFrameWithExactLength =
            ForumImageMapper.ToImage([0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x07, 0x08, 0x00, 0x10, 0x00, 0x00], "image/jpeg");
        var shortStartOfFrame = ForumImageMapper.ToImage([0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x11, 0x08], "image/jpeg");
        var zeroSizedFrame =
            ForumImageMapper.ToImage([0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x08, 0x08, 0x00, 0x00, 0x00, 0x10, 0x00],
                "image/jpeg");
        var widthZeroFrame =
            ForumImageMapper.ToImage([0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x08, 0x08, 0x00, 0x10, 0x00, 0x00, 0x00],
                "image/jpeg");
