...
public class Rc4Test
{
    ...
    [TestMethod]
    public void ConstructorAndCrypt_RejectNullAndEmptyInputs()
    {
        Assert.ThrowsExactly<ArgumentNullException>(() => new Rc4(null!));
        Assert.ThrowsExactly<ArgumentException>(() => new Rc4([]));

        var rc4 = new Rc4(Encoding.UTF8.GetBytes("f00c29de98c67b3866a9a816efde42eb"));

        Assert.ThrowsExactly<ArgumentNullException>(() => rc4.Crypt(null!));
    }
}
