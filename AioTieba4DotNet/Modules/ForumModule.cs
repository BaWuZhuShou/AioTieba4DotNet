...
public sealed class ForumModule : IForumModule
{
    ...
    {
        return _protocol.GetFollowForumsAsync(userId, pn, rn, cancellationToken);
    }
    ...
    public Task<SelfFollowForums> GetSelfFollowForumsAsync(int pn = 1, int rn = 200,
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetSelfFollowForumsAsync(pn, rn, cancellationToken);
    }
    ...
    public Task<ForumImage> GetImageByHashAsync(string rawHash, ForumImageSize size = ForumImageSize.Small,
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetImageByHashAsync(rawHash, size, cancellationToken);
    }
    ...
    public Task<ForumImage> GetPortraitAsync(string portrait, ForumImageSize size = ForumImageSize.Small,
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetPortraitAsync(portrait, size, cancellationToken);
    }
    ...
    public Task<ExactSearches> SearchExactAsync(string fname, string query, int pn = 1, int rn = 30,
        ...
        CancellationToken cancellationToken = default)
    {
        return _protocol.SearchExactAsync(fname, query, pn, rn, searchType, onlyThread, cancellationToken);
    }
    ...
    public Task<ExactSearches> SearchExactAsync(ulong fid, string query, int pn = 1, int rn = 30,
        ...
        CancellationToken cancellationToken = default)
    {
        return _protocol.SearchExactAsync(fid, query, pn, rn, searchType, onlyThread, cancellationToken);
    }
    ...
    public Task<LastReplyers> GetLastReplyersAsync(string fname, int pn = 1, int rn = 30,
        ...
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetLastReplyersAsync(fname, pn, rn, sort, isGood, cancellationToken);
    }
    ...
    public Task<LastReplyers> GetLastReplyersAsync(ulong fid, int pn = 1, int rn = 30,
        ...
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetLastReplyersAsync(fid, pn, rn, sort, isGood, cancellationToken);
    }
    ...
    public Task<MemberUsers> GetMemberUsersAsync(string fname, int pn = 1,
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetMemberUsersAsync(fname, pn, cancellationToken);
    }
    ...
    public Task<MemberUsers> GetMemberUsersAsync(ulong fid, int pn = 1,
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetMemberUsersAsync(fid, pn, cancellationToken);
    }
    ...
    {
        return _protocol.GetRankForumsAsync(fname, pn, rankType, cancellationToken);
    }
    ...
    public Task<DislikeForums> GetDislikeForumsAsync(int pn = 1, int rn = 20,
        CancellationToken cancellationToken = default)
    {
        return _protocol.GetDislikeForumsAsync(pn, rn, cancellationToken);
    }
}
