...
public sealed class AdminModule : IAdminModule
{
    ...
    public Task<bool> UnblockAsync(string fname, long userId, CancellationToken cancellationToken = default) =>
        _protocol.UnblockAsync(fname, userId, cancellationToken);
}
