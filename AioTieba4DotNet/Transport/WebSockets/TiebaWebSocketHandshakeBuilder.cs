...
internal sealed class TiebaWebSocketHandshakeBuilder
{
    ...
    [SuppressMessage("Minor Code Smell", "S2325:Methods and properties that don't access instance data should be static",
        Justification = "The handshake builder is kept as a dedicated collaborator in the WebSocket engine composition so handshake packing can evolve behind a single seam without changing callers.")]
    ...
    [SuppressMessage("Security", "S5542:Use secure mode and padding scheme.",
        Justification = "Tieba websocket handshake encryption is protocol-defined and must stay aligned with the upstream aiotieba implementation and remote server expectations.")]
