...
internal static class CommentMapper
{
    internal static Comment FromTbData(SubPostList? dataProto)

        {
            ...
            if (dataProto == null) return new Comment { Content = AioTieba4DotNet.Internal.Mapping.ContentMapper.FromTbData((IEnumerable<PbContent>?)null) };



            var content = AioTieba4DotNet.Internal.Mapping.ContentMapper.FromTbData(dataProto.Content);
