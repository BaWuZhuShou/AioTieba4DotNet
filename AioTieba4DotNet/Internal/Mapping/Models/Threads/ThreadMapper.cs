    ...
    internal static ThreadModel FromTbData(ThreadInfo? threadInfo)

        {
            ...
            if (threadInfo == null)
                ...
                return new ThreadModel { Content = AioTieba4DotNet.Internal.Mapping.ContentMapper.FromTbData((ThreadInfo?)null), VirtualImage = new VirtualImagePf() };
...

            {
                ...
                User = AioTieba4DotNet.Internal.Mapping.UserInfoTMapper.FromTbData(threadInfo.Author),

                AuthorId = threadInfo.AuthorId,

                VirtualImage = AioTieba4DotNet.Internal.Mapping.VirtualImagePfMapper.FromTbData(threadInfo),
                ...
                ShareOrigin = threadInfo is { IsShareThread: 1, OriginThreadInfo.Pid: > 0 }
                    ...
                    ? AioTieba4DotNet.Internal.Mapping.ShareThreadMapper.FromTbData(threadInfo.OriginThreadInfo)
