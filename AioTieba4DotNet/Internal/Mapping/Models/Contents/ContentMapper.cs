    ...
    internal static Content FromTbData(ThreadInfo.Types.OriginThreadInfo threadInfo)

        {
...

            {

                {
...

                    {
                        ...
                        var text = AioTieba4DotNet.Internal.Mapping.FragTextMapper.FromTbData(content);
...

                {
...

                    {
                        ...
                        var emoji = AioTieba4DotNet.Internal.Mapping.FragEmojiMapper.FromTbData(content);
...

                {
...

                    {
                        ...
                        var image = AioTieba4DotNet.Internal.Mapping.FragImageMapper.FromTbData(content);
...

                {
...

                    {
                        ...
                        voice = AioTieba4DotNet.Internal.Mapping.FragVoiceMapper.FromTbData(content);
...

                {
...

                    {
                        ...
                        var tiebaPlus = AioTieba4DotNet.Internal.Mapping.FragTiebaPlusMapper.FromTbData(content);
...

            {
                ...
                video = AioTieba4DotNet.Internal.Mapping.FragVideoMapper.FromTbData(threadInfo.VideoInfo);
...

            {
                ...
                voice = AioTieba4DotNet.Internal.Mapping.FragVoiceMapper.FromTbData(threadInfo.VoiceInfo[0]);
    ...
    internal static Content FromTbData(PostInfoList dataRes)

        {
            ...
            if (dataRes.Media is { Count: > 0 })
                ...
                foreach (var image in dataRes.Media.Where(m => m.Type != 5).Select(AioTieba4DotNet.Internal.Mapping.FragImageMapper.FromTbData))
...

            {
                ...
                var video = AioTieba4DotNet.Internal.Mapping.FragVideoMapper.FromTbData(dataRes.VideoInfo);
...

            {
                ...
                var voice = AioTieba4DotNet.Internal.Mapping.FragVoiceMapper.FromTbData(dataRes.VoiceInfo[0]);
...

            {
...

                {
...

                    {
                        ...
                        video = AioTieba4DotNet.Internal.Mapping.FragVideoMapper.FromTbData(content);
