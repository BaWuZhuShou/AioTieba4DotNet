...
{
    public async Task<UserInfoGuInfoWeb> RequestAsync(int userId, CancellationToken cancellationToken = default)
    {
    ...
    private static UserInfoGuInfoWeb ParseResponse(string body)
    {
