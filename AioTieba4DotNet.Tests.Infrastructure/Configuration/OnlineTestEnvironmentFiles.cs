...
{
    public const string SafeTemplateRelativePath = "AioTieba4DotNet.Tests.Infrastructure/online-test.safe.template.json";
    public const string RestrictedTemplateRelativePath = "AioTieba4DotNet.Tests.Infrastructure/online-test.restricted.template.json";
